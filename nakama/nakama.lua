...
function M.healthcheck(
	...
	if callback then
		...
		client.config.http_fn(client.config, url_path, query_params, "GET", post_data, function(result)
			callback(result)
		end)
	else
...
function M.update_account(
	...
	if callback then
		...
		client.config.http_fn(client.config, url_path, query_params, "PUT", post_data, function(result)
			callback(result)
		end)
	else
...
function M.authenticate_custom(
	...
	if callback then
		...
		client.config.http_fn(client.config, url_path, query_params, "POST", post_data, function(result)
...
function M.delete_friends(
	...
	if callback then
		...
		client.config.http_fn(client.config, url_path, query_params, "DELETE", post_data, function(result)
			callback(result)
		end)
	else
