...
-- Code generated by codegen/generate-nakama-realtime.py DO NOT EDIT.
...
def parse_proto_message(message):
	...
	# remove inner enum
	message = re.sub(r"enum .* \{.*?}?", "", message, flags=re.DOTALL | re.MULTILINE)
	# remove inner message
	message = re.sub(r"message .* \{.*?}?", "", message, flags=re.DOTALL | re.MULTILINE)
